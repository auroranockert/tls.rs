...
impl Hash for MD5 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(16);
...
impl Hash for SHA1 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(20);
...
impl Hash for SHA224 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(28);
...
impl Hash for SHA256 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(32);
...
impl Hash for SHA384 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(48);
...
impl Hash for SHA512 {
  ...
  fn digest(&mut self) -> secure_buffer::SecureBuffer {
    let mut result = secure_buffer::SecureBuffer::new(64);
